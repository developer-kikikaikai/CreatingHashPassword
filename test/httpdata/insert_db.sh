...
mysql -u $1 -p$2 -D $3 -e "INSERT INTO passphrase_tbl values('test', 'sha256', 'seed1', '64', 'true', 'testtitle1')"
mysql -u $1 -p$2 -D $3 -e "INSERT INTO passphrase_tbl values('test', 'sha512', 'seed2', '128', 'false', 'testtitle2')"
