...
func (this MsgHandler) Get(c echo.Context, r *auth.AuthenticatedRequest) error {
	return c.NoContent(http.StatusMethodNotAllowed)
}
func (this MsgHandler) Put(c echo.Context, r *auth.AuthenticatedRequest) error {
	return c.NoContent(http.StatusMethodNotAllowed)
}
func (this MsgHandler) Post(c echo.Context, r *auth.AuthenticatedRequest) error {
	return c.NoContent(http.StatusMethodNotAllowed)
}
func (this MsgHandler) Delete(c echo.Context, r *auth.AuthenticatedRequest) error {
	return c.NoContent(http.StatusMethodNotAllowed)
}
